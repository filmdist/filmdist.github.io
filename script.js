...
function clearContent(inputStudio) {
    ...
    bubbleChart = Highcharts.chart('bubbleChart', {
        ...
        title: {
            text: 'Top 50 Grossing Movies by Season from ' + inputStudio + ' not found'
        }
    });
...
function changeContent(inputStudio) {
    ...
    document.getElementById('totalGross').innerHTML = '$' + formatMoneyNum(totalGross)
    ...
    document.getElementById('maxGross').innerHTML = '$' + maxFilm.gross.toFixed(0)
    ...
    let mapYear = d3.rollups(currData, v => d3.sum(v, d => d.gross), d => d.year).reverse()
    ...
    bubbleChart = Highcharts.chart('bubbleChart', {
        ...
        title: {
            text: 'Top 50 Grossing Movies by Season'
        },
        credits: {
            enabled: false
        },
...
function getSeasonGraph(currData, currentYear) {
    ...
    let seasonData = d3.rollups(currData, v => v.length, d => d.season)
    var data = {} 
    data[currentYear] = seasonData

    let seasonPreviousData = d3.rollups(previousYearData, v => v.length, d => d.season)
    var dataHm = {} 
...
function getArrayOfTickers(currData) {
    ...
    let firstTicker = goalTicker * .3
    let secondTicker = (goalTicker * .5) + goalTicker
...
function getArrayOfTickersTotalGross(currData) {
    ...
    let firstTicker = goalTicker * .3
    let secondTicker = (goalTicker * .1) + goalTicker
...
function getBulletGraphs(currData) {
    ...
    bullet1 = Highcharts.chart('bullet1', {
        chart: {
            marginTop: 90,
            inverted: true,
            marginLeft: 125,
        ...
        title: {
            text: mostRecentYear + ' Performance compared to previous year ' + (mostRecentYear - 1)
        },
        xAxis: {
            categories: ['<span class="hc-cat-title">Average Film Gross </span><br/>U.S. $ ']
        },
        legend: {
            enabled: false
        },
    ...
    bullet2 = Highcharts.chart('bullet2', {
        chart: {
            inverted: true,
            marginTop: 0,
            marginLeft: 125,
        ...
        xAxis: {
            categories: ['<span class="hc-cat-title">Average Film Total Gross </span><br/>U.S. $ ']
        },
        legend: {
            enabled: false
        },
        ...
        yAxis: {
            ...
            plotBands: [{
                from: 0,
                to: totalGrossTickers[0],
                color: '#999'
            }, {
                from: totalGrossTickers[0],
                to: totalGrossTickers[1],
                color: '#bbb'
            }, {
                from: totalGrossTickers[1],
                to: 9e9,
                color: '#edf2f4'
            }],
            title: null
        ...
        series: [{
            data: [{
                y: totalGrossTickers[2],
                target: totalGrossTickers[3]
            }]
        }],
        tooltip: {
            pointFormat: '<b>${point.y}</b> (with target at ${point.target})'
    ...
    bullet3 = Highcharts.chart('bullet3', {
        chart: {
            inverted: true,
            marginTop: 0,
            marginLeft: 125,
        ...
        xAxis: {
            categories: ['<span class="hc-cat-title">Sum Total Gross </span><br/>U.S. $ ']
        },
        legend: {
            enabled: false
        },
        ...
        yAxis: {
            ...
            plotBands: [{
                from: 0,
                to: sumTotalGrossTickers[0],
                color: '#999'
            }, {
                from: sumTotalGrossTickers[0],
                to: sumTotalGrossTickers[1],
                color: '#bbb'
            }, {
                from: sumTotalGrossTickers[1],
                to: 9e9,
                color: '#edf2f4'
            }],
            title: null
        ...
        series: [{
            data: [{
                y: sumTotalGrossTickers[2],
                target: sumTotalGrossTickers[3]
            }]
        }],
        tooltip: {
            pointFormat: '<b>${point.y}</b> (with target at ${point.target})'
    ...
    bullet4 = Highcharts.chart('bullet4', {
        chart: {
            inverted: true,
            marginTop: 0,
            marginLeft: 125,
        ...
        xAxis: {
            categories: ['<span class="hc-cat-title">Sum Gross </span><br/>U.S. $ ']
        },
        legend: {
            enabled: false
        },
        ...
        yAxis: {
            ...
            plotBands: [{
                from: 0,
                to: sumGrossTickers[0],
                color: '#999'
            }, {
                from: sumGrossTickers[0],
                to: sumGrossTickers[1],
                color: '#bbb'
            }, {
                from: sumGrossTickers[1],
                to: 9e9,
                color: '#edf2f4'
            }],
            title: null
...
function changeStudio(inputStudio) {
    ...
    if (inputStudio === 'all') {
        ...
        currData = ultData.filter(function (d) {
            ...
            // return d["studio"] === "A24" || d["studio"] === "yeehawdisneyboooooo"
        })
    ...
    if (currData.length == 0) {
        alert("Sorry, " + inputStudio + " is not a valid distributor, please search for another in the list.")
        ...
        let dateStart = '2020-12-13'
        let dateEnd = '2020-12-13'
...
window.onload = function () {
    ...
    function studioListener() {
        ...
        // console.log("Changing to " + inputStudio)
